...
const givers_jptr_1 = require("./givers_jptr");
...
let givers = givers_jptr_1.givers1000;
if (args['--givers']) {
    ...
    switch (val) {
        case 100:
            givers = givers_jptr_1.givers100;
            console.log('Using givers 100');
            break;
        case 1000:
            givers = givers_jptr_1.givers1000;
            console.log('Using givers 1 000');
            break;
        case 10000:
            givers = givers_jptr_1.givers10000;
            console.log('Using givers 10 000');
            break;
        case 100000:
            givers = givers_jptr_1.givers100000;
    ...
    return __awaiter(this, void 0, void 0, function* () {
        if (liteClient instanceof ton_1.TonClient4) {
            ...
            try {
                ...
                const left = BigInt(powInfo.stack[3].num);
                if (left < BigInt(1)) {
                    throw new Error('no jptr left');
                }
